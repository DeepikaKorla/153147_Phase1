...
public class TestClass {
	...
	{
		service.createAccount("", "9492451841", new BigDecimal(2000));
	}
	...
	{
		service.createAccount("deepika", "809", new BigDecimal(1500));
	}
	...
	{
		Customer actual = service.createAccount("deepika", "9492451841", new BigDecimal(5000));
	...
	{
		service.createAccount("deepika", "9492451841", new BigDecimal(9000));
		service.createAccount("dpika", "9492451841", new BigDecimal(10000));
	}
	...
	{
		service.createAccount("deepika", "9492451841", new BigDecimal(-100));
	}
	...
	{
		service.createAccount("deepika", "9603924466", new BigDecimal(7000));
	...
	{
		service.createAccount("devi", "8639119207", new BigDecimal(1000));
		service.createAccount("Rahul", "9440827011", new BigDecimal(1000));
